...
int main()
{
    ...
    glVertexAttribPointer(0, 2, GL_FLOAT, GL_FALSE, 0, 5 * sizeof(float));                  //burası yanlıs olabilir
    glVertexAttribPointer(1, 3, GL_FLOAT, GL_FALSE, 2 * sizeof(float), 5 * sizeof(float);
